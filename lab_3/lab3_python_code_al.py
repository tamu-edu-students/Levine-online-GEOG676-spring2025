...
#read txt file
file = open('/Users/ajlevine/Library/CloudStorage/OneDrive-TexasA&MUniversity/TAMUG/Courses/GEOG676/lab3/shape.txt', 'r')
...
for line in lines:
    ...
    if shape == "Rectangle":
        rect = Rectangle(int(components[1]), int(components[2])) #int = integer
